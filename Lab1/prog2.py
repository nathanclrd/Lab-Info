...
def mru_1d(depart, temps_depart, vitesse, temps_maintenant):
    return depart+vitesse*(temps_maintenant-temps_depart)
...
def calculer_tir(depart, cible, vitesse, prochain_temps_cible,temps_maintenant):
    ...
    temps_montee = (cible-depart)/vitesse
    if temps_montee < prochain_temps_cible-temps_maintenant:
        tir_est_possible = True
        temps_tir = prochain_temps_cible-temps_montee
