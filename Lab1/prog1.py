...
def coord_terrain_vers_fenetre(point_terrain, dimensions_fenetre,largeur_terrain):

    x_t, y_t = point_terrain
    x_f = dimensions_fenetre[0]/2 + dist_terrain_vers_fenetre(x_t,dimensions_fenetre[0],largeur_terrain)
    y_f = dimensions_fenetre[1]/2 + dist_terrain_vers_fenetre(-y_t,dimensions_fenetre[1],largeur_terrain)
    return (x_f, y_f)
...
def coord_fenetre_vers_terrain(point_fenetre, dimensions_fenetre,largeur_terrain):
    ...
    x_t = dist_fenetre_vers_terrain(x_f-dimensions_fenetre[0]/2,dimensions_fenetre[0],largeur_terrain) 
    y_t = - dist_fenetre_vers_terrain(y_f-dimensions_fenetre[1]/2,dimensions_fenetre[0],largeur_terrain) 
    return (x_t, y_t)
